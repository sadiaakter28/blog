...
@section('title', 'Home')
@push('css')
    <link href="{{asset('assets/frontend/common-css/home/styles.css')}}" rel="stylesheet">
    <link href="{{asset('assets/frontend/common-css/home/responsive.css')}}" rel="stylesheet">
@endpush
@section('content')
